    ...
    <div class="container px-5 py-10 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <img fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-12 h-12 bg-black-500 rounded-full" viewBox="0 0 24 24" src="assects/images/defaults/logo-white.png">
                <span class="ml-3 text-xl text-[#fff]">UpdateGadh Technical School</span>
            </a>
        ...
        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav class="list-none mb-10">
                    <li>
                        <a class="text-sm md:text-base text-[#888} hover:text-[#ff9f45] cursor-pointer" onclick="locationmap()"> UpdateGadh , UpdateGadh.com</a>
                    </li>
                    <li>
                        <a class="text-sm md:text-base text-[#888} hover:text-[#ff9f45] cursor-pointer" onclick="callschool()"> 0000000000</a>
                    </li>
                    <li>
                        <a class="text-sm md:text-base text-[#888} hover:text-[#ff9f45] cursor-pointer" onclick="mailschool()">UpdateGadh<br>@gmail.com</a>
                    </li>
                    <li>
                        <a class="text-sm md:text-base text-[#888} hover:text-[#ff9f45] cursor-pointer" onclick="locationmap()"> Technical School</a>
                    </li>
                </nav>
            </div>
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <nav class="list-none mb-10">
                    <li onclick="developers()">
                        <a class="text-sm md:text-base text-[#888} hover:text-[#ff9f45] cursor-pointer">UpdateGadh</a>
                    </li>
                    </li>
                </nav>
            </div>
    ...
    <div class="bg-[#03212e]">
        <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-sm md:text-base text-gray-500 text-sm text-center sm:text-left">Copyright © 2023 - <?php echo date("Y"); ?> All rights reserved by -
                <a href="https://technicalpashupati.edu.np" rel="noopener noreferrer" class="text-[#fff] ml-1" target="_blank">Updategadh Technical Secondary School</a>
            </p>
